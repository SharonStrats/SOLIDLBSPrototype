...
function () {
  ...
  */
  function UpdateManager(store) {
    ...
    store = store || new _store.default(); // If none provided make a store
  ...
  (0, _createClass2.default)(UpdateManager, [{
    ...
    value: function editable(uri, kb) {
      ...
      if (uri.slice(0, 8) === 'file:///') {
        if (kb.holds(kb.sym(uri), _dataFactory.default.namedNode('http://www.w3.org/1999/02/22-rdf-syntax-ns#type'), _dataFactory.default.namedNode('http://www.w3.org/2007/ont/link#MachineEditableDocument'))) {
          return 'LOCALFILE';
        }
    ...
    value: function setRefreshHandler(doc, handler) {
      ...
      wssURI = (0, _uri.join)(wssURI, doc.uri);
    ...
    value: function update(deletions, insertions, callbackFunction, secondTry) {
      ...
      try {
        var kb = this.store;
        var ds = !deletions ? [] : deletions instanceof _store.default ? deletions.statements : deletions instanceof Array ? deletions : [deletions];
        var is = !insertions ? [] : insertions instanceof _store.default ? insertions.statements : insertions instanceof Array ? insertions : [insertions];
