...
var ns = {
  link: (0, _namespace.default)('http://www.w3.org/2007/ont/link#'),
  http: (0, _namespace.default)('http://www.w3.org/2007/ont/http#'),
  httph: (0, _namespace.default)('http://www.w3.org/2007/ont/httph#'),
  // headers
  rdf: (0, _namespace.default)('http://www.w3.org/1999/02/22-rdf-syntax-ns#'),
  rdfs: (0, _namespace.default)('http://www.w3.org/2000/01/rdf-schema#'),
  dc: (0, _namespace.default)('http://purl.org/dc/elements/1.1/'),
  ldp: (0, _namespace.default)('http://www.w3.org/ns/ldp#')
};
    ...
    value: function parse(fetcher, responseText, options, response) {
      ...
      for (var i = 0; i < scripts.length; i++) {
        ...
        if (Parsable[contentType]) {
          (0, _parse.default)(scripts[i].textContent, kb, options.original.uri, contentType);
          (0, _parse.default)(scripts[i].textContent, kb, options.original.uri, contentType);
        }
      }
      ...
      if (!options.noRDFa && _rdfaparser.parseRDFaDOM) {
        // enable by default
        try {
          (0, _rdfaparser.parseRDFaDOM)(this.dom, kb, options.original.uri);
        } catch (err) {
...
function (_Handler6) {
  ...
  (0, _createClass2.default)(N3Handler, [{
    ...
    value: function parse(fetcher, responseText, options, response) {
      ...
      var kb = fetcher.store;
      var p = (0, _n3parser.default)(kb, kb, options.original.uri, options.original.uri, null, null, '', null); //                p.loadBuf(xhr.responseText)
  ...
  */
  ...
  (0, _createClass2.default)(Fetcher, [{
    ...
    value: function nowOrWhenFetched(uri, p2, userCallback) {
      ...
      } else if (p2 instanceof _namedNode.default) {
        // referringTerm = p2
    ...
    value: function putBack(uri) {
      ...
      var doc = new _namedNode.default(uri).doc(); // strip off #

      options.contentType = options.contentType || 'text/turtle';
      options.data = (0, _serialize.default)(doc, this.store, doc.uri, options.contentType);
