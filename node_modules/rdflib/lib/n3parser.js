  ...
  */
  ...
  __SinkParser.prototype.tok = function (tok, str, i) {
    ...
    if (str.slice(i, i + 1) == "@") {
      ...
      if ((0, _util.ArrayIndexOf)(this.keywords, tok) < 0) {
        return -1;
      }
    }
    ...
    if (j > 0) {
      ...
      try {
        while (true) {
          ...
          if ((0, _util.ArrayIndexOf)(this._variables, x) < 0 || (0, _util.ArrayIndexOf)(this._parentVariables, x) >= 0) {
  ...
  __SinkParser.prototype.uri_ref2 = function (str, i, res) {
    ...
    */
    ...
    if (j >= 0) {
      ...
      if ((0, _util.ArrayIndexOf)(this._variables, symb) >= 0) {
    ...
    if (str.charAt(i) == "?") {
      ...
      if ((0, _util.ArrayIndexOf)(this.keywords, v[0]) >= 0) {
  ...
  __SinkParser.prototype.qname = function (str, i, res) {
    ...
    */
    ...
    if (i < pyjslib_len(str) && str.charAt(i) == ":") {
      ...
      if (ln && this.keywordsSet && (0, _util.ArrayIndexOf)(this.keywords, ln) < 0) {
