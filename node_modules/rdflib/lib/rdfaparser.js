  ...
  (0, _createClass2.default)(RDFaProcessor, [{
    ...
    value: function addTriple(origin, subject, predicate, object) {
      ...
      if (typeof subject === 'undefined') {
        su = _dataFactory.default.namedNode(this.options.base);
      } else {
      ...
      or = _dataFactory.default.namedNode(this.options.base); // console.log('Adding { ' + su + ' ' + pr + ' ' + ob + ' ' + or + ' }')
    ...
    value: function toRDFNodeObject(x) {
      ...
      if (typeof x === 'string') {
        ...
        return _dataFactory.default.namedNode(x);
      }
      ...
      switch (x.type) {
        case RDFaProcessor.objectURI:
          ...
          return _dataFactory.default.namedNode(x.value);
