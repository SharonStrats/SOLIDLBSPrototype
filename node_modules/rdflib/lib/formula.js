  ...
  */
  ...
  (0, _createClass2.default)(Formula, [{
    ...
    value: function add(subject, predicate, object, graph) {
      return this.statements.push(new _statement.default(subject, predicate, object, graph));
    }
    ...
    */
    ...
    value: function bnode(id) {
      return new _blankNode.default(id);
    }
  }, {
    key: "addAll",
    ...
    */
    ...
    value: function anyJS(s, p, o, g) {
      var y = this.any(s, p, o, g);
      return y ? _node.default.toJS(y) : void 0;
    }
  }, {
    ...
    */
    ...
    value: function fromNT(str) {
      ...
      switch (str[0]) {
        ...
        case '_':
          return new _blankNode.default(str.slice(2));
    ...
    value: function holds(s, p, o, g) {
      ...
      if (arguments.length === 1) {
        ...
        if (s instanceof Array) {
          ...
          return true;
        } else if (s instanceof _statement.default) {
...
Formula.prototype.classOrder = _classOrder.default['Graph'];
Formula.prototype.isVar = 0;
Formula.prototype.ns = _namespace.default;
