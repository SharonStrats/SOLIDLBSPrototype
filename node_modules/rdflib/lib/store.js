...
exports.default = exports.defaultGraphURI = void 0;
...
function (_Formula) {
  ...
  (0, _createClass2.default)(IndexedFormula, [{
    ...
    value: function initPropertyActions(features) {
      ...
      if ((0, _util.ArrayIndexOf)(features, 'sameAs') >= 0) {
      ...
      if ((0, _util.ArrayIndexOf)(features, 'InverseFunctionalProperty') >= 0) {
      ...
      if ((0, _util.ArrayIndexOf)(features, 'FunctionalProperty') >= 0) {
    ...
    value: function add(subj, pred, obj, why) {
      ...
      if (arguments.length === 1) {
        ...
        } else if (subj instanceof _statement.default) {
      ...
      subj = _node.default.fromValue(subj);
      pred = _node.default.fromValue(pred);
      obj = _node.default.fromValue(obj);
      ...
      st = new _statement.default(subj, pred, obj, why);
    ...
    value: function copyTo(template, target, flags) {
      ...
      if ((0, _util.ArrayIndexOf)(flags, 'two-direction') !== -1) {
      ...
      for (var i = 0; i < statList.length; i++) {
        ...
        if ((0, _util.ArrayIndexOf)(flags, 'delete') !== -1) {
          this.remove(st);
        }
      }
    }
    ...
    value: function query(myQuery, callback, dummy, onDone) {
      return _query.indexedFormulaQuery.call(this, myQuery, callback, dummy, onDone);
    }
    ...
    value: function removeStatement(st) {
      ...
      for (var p = 0; p < 4; p++) {
        ...
        if (!this.index[p][h]) {// log.warn ("Statement removal: no index '+p+': "+st)
          ...
          (0, _util.RDFArrayRemove)(this.index[p][h], st);
        }
      }

      (0, _util.RDFArrayRemove)(this.statements, st);
      return this;
    }
  }, {
