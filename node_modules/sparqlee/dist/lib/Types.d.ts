...
export declare type NamedFuncHook = (expression: Alg.NamedExpression) => Promise<RDF.Term>;
export declare type AggregateHook = (expression: Alg.AggregateExpression) => Promise<RDF.Term>;
export declare type ExistenceHook = (expression: Alg.ExistenceExpression, mapping: Bindings) => Promise<boolean>;
