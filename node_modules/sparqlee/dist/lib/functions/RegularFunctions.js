...
const STRBEFORE = {
    ...
    overloads: Helpers_1.declare()
        ...
        return (sub) ? Helpers_1.langString(sub, arg1.language) : Helpers_1.string(sub);
    })
        .onBinary(['langString', 'langString'], (arg1, arg2) => {
        if (arg1.language !== arg2.language) {
            throw new Err.IncompatibleLanguageOperation(arg1, arg2);
...
const replace3 = (arg, pattern, replacement) => Helpers_1.string(X.replace(arg, pattern, replacement));
const replace4 = (arg, pattern, replacement, flags) => Helpers_1.string(X.replace(arg, pattern, replacement, flags));
const REPLACE = {
    arity: [3, 4],
    overloads: Helpers_1.declare()
